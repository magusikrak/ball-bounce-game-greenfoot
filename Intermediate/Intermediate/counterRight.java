...
public class counterRight extends Actor
{
    ...
    public void act() 
    {
      ...
      GreenfootImage img = new GreenfootImage(s,40,Color.BLACK,Color.WHITE);//creates a greenfoot image "img" and sets it to display text from "s" variable, font size 40, text colour black and background colour whte
